...
const updateUser = async (req, res) => {
    try {
        const { id } = req.params;
        const { first_name, last_name, role, phone_number, status, email, password } = req.body; 
        
        await userService.updateUser(id, { first_name, last_name, role, phone_number, status, email, password });
